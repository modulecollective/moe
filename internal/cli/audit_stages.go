...
// shape.
var openAuditStage func(stage, projectID, runID string, headless, suppressNextStage bool, stdout, stderr io.Writer) int
...
func init() {
	...
	registerCascadeDispatcher(auditWorkflow, func(stage, projectID, runID string, headless, suppressNextStage bool, stdout, stderr io.Writer) int {
		return openAuditStage(stage, projectID, runID, headless, suppressNextStage, stdout, stderr)
	})
}
